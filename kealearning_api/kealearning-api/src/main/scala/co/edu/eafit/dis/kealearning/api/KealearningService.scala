package co.edu.eafit.dis.kealearning.api
...
object KealearningService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The kealearning service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the KealearningService.
  */
trait KealearningService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("kealearning")
      ...
      .withTopics(
        topic(KealearningService.TOPIC_NAME, greetingsTopic _)
